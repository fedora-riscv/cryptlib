...
/*	LOOP_SMALL_REV_ALT( i = 5, i >= 0, i-- )
	...
	if( !CFI_CHECK_SEQUENCE_7( "BOOLEAN", "bitflags", "pointers", "TMR", 
							   "CFI", "loops", "buffers" ) )
		return( FALSE );
	if( CFI_CHECK_SEQUENCE_7( "BOOLEAN", "pointers", "bitflags", "TMR",
							  "CFI", "loops", "buffers" ) )
		return( FALSE );
	if( CFI_CHECK_SEQUENCE_7( "BOOLEAN", "bitflags", "loops", "buffers", 
							  "pointers", "TMR", "CFI" ) )
		return( FALSE );
